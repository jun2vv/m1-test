...
<body>
	...
	<table class="table table-bordered">
		...
		<a class="btn btn-success" href="<%=request.getContextPath() %>/teacher/teacherInsert.jsp">과목추가</a>
		<a class="btn btn-success" href="<%=request.getContextPath() %>/teacher_subject/teacher_subject_insert.jsp">강사담당과목추가</a>
